      ...
      >
        ...
        <div className="newsmodal-top">
          ...
          <div className="newsmodal-meta">
            ...
            <span className="newsmodal-date">
              {moment(newsData.date).format("MMMM Do, YYYY")}
            </span>
          </div>
        </div>
            ...
            {images.length > 0 ? (
              images.map((image, index) => (
                <img
                  ...
                  alt={`${newsData.headline} image ${index + 1}`}
                  className="newsmodal-image"
                  loading="lazy"
                />
              ))
            ) : (
