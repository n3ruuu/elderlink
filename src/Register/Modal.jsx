...
const Modal = ({ onClose }) => {
	...
	const generatePDF = () => {
		...
		const paragraphText = 'I hereby subscribed and sworn that all the information given in this registration form are true and correct, and I am not a holder of any OSCA ID issued by the other Cities or Municipalities, and avow under the penalty of Law to the truth of its contents.';
